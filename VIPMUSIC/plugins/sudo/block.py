...
@app.on_message(filters.command(["block","حظر"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["unblock","الغاء الحظر"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["blocked", "المحظورين", "blusers"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & SUDOERS)
@language
