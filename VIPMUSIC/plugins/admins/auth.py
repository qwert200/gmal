...
@app.on_message(filters.command(["رفع ادمن","اد"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command(["تنزيل ادمن","تن"] ,prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminActual
